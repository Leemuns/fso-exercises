...
describe('favorite blog', () => {
  ...
  test('when list has multiple blogs, return the blog with highest number of likes', () => {
    const result = listHelper.favoriteBlog(blogList)
    assert.deepStrictEqual(result, blogWithMostLikes)
  })

  test('when list has multiple favorites, return the first in the list', () => {
    const result = listHelper.favoriteBlog(blogListManyFavorites)
    assert.deepStrictEqual(result, blogWithMostLikes)
  })
})